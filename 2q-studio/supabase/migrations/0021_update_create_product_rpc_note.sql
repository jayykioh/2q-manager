-- 0021_update_create_product_rpc_note.sql

DROP FUNCTION IF EXISTS create_product(TEXT, TEXT, product_type, product_tier, UUID, NUMERIC, NUMERIC, NUMERIC, JSONB);
  ...
  IF p_images IS NOT NULL AND jsonb_array_length(p_images) > 0 THEN
    ...
    LOOP
      INSERT INTO public.product_images (
        ...
        COALESCE((img->>'angle')::product_image_angle, 'front'),
