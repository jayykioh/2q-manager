-- ==============================================================================
-- 0018_fix_checkout_order_notification.sql: Fix notification column in checkout_order
-- ==============================================================================
...
DECLARE
  ...
  v_product_id UUID;
  v_notification_msg TEXT := 'Bạn có đơn hàng mới : ';
...
BEGIN
  ...
  VALUES ('order', 'Đơn hàng mới ' || v_order_number, v_notification_msg)
